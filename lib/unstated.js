...
// No need for _interopDefault if we require from react directly
...
// Use React's built-in createContext
var StateContext = React.createContext(null);
...
var Container = (function () {
  ...
  Container.prototype.setState = function setState(updater, callback) {
    console.log('Container setState:', {updater: updater, callback: callback});
    var _this2 = this;
  ...
  Container.prototype.subscribe = function subscribe(fn) {
    console.log('Container subscribe:', fn);
    this._listeners.push(fn);
  };

  Container.prototype.unsubscribe = function unsubscribe(fn) {
    console.log('Container unsubscribe:', fn);
...
var Subscribe = (function (_React$Component) {
  ...
  Subscribe.prototype._createInstances = function _createInstances(
    ...
    console.log('Subscribe _createInstances:', {
      map: map,
  ...
  Subscribe.prototype.render = function render() {
    ...
    return React.createElement(StateContext.Consumer, null, function (map) {
      // Replace children.apply with spread operator
      return _this6.props.children(
...
exports.__SUPER_SECRET_CONTAINER_DEBUG_HOOK__ =
